import { getAskAiLinks } from "@/lib/ask-ai";

/** Official OpenAI mark (Simple Icons) */
function ChatGptIcon({ className }: { className?: string }): React.ReactElement {
  return (
...
/** Official Claude starburst (Simple Icons) */
...
function GeminiIcon({ className }: { className?: string }): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className={className} fill="currentColor">
...
function PerplexityIcon({ className }: { className?: string }): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className={className} fill="currentColor">
...
interface AskAiAboutBrandProps {
  theme?: "light" | "dark";
          ...
          return (
            <li key={platform.id} className="flex items-center">
              ...
              <a
                ...
                title={platform.name}
                className={`group inline-flex h-9 w-9 items-center justify-center rounded-md transition-colors duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-accent ${
                  isDark
                    ? "text-neutral-400 hover:text-brand-accent"
