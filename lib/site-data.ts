...
export const HERO_CAROUSEL_CASE_STUDIES: CaseStudy[] = [
  heroCarouselCase(
    ...
    "+51%",
    "pipeline growth at the same ad spend",
  ...
  heroCarouselCase(
    ...
    "Canopy",
    "25%",
    "of enterprise pipeline generated",
  ...
  heroCarouselCase(
    ...
    "Direct2Compensation",
    "+112%",
    "case enquiry volume from paid search",
...
export const WORK_ONLY_CASE_STUDIES: CaseStudy[] = [
  ...
  ),
  {
    ...
    title: "Northwest Solicitors | 78% revenue growth year on year",
    description:
      "How Bright Brand helped Northwest Solicitors grow revenue by 78% year on year through paid search and performance marketing.",
    imageAlt:
      "Northwest Solicitors solicitors in a client meeting reviewing case strategy and growth plans",
  },
  heroCarouselCase(
    "baker-ashley",
    "Baker Ashley Solicitors",
    "+87%",
    "employment enquiry growth",
...
export const BRITTON_FEATURED_LOGOS: QuotePartnerLogo[] = [
  {
    id: "bbc",
    name: "BBC",
    src: "/quote-logos/britton-and-time/bbc.png",
    width: 200,
    height: 72,
  },
  {
    id: "the-argus",
    name: "The Argus",
    src: "/quote-logos/britton-and-time/the-argus.png",
    width: 200,
    height: 72,
  },
  {
    id: "the-sun",
    name: "The Sun",
    src: "/quote-logos/britton-and-time/the-sun.png",
    width: 200,
    height: 72,
  },
  {
    id: "gb-news",
    name: "GB News",
    src: "/quote-logos/britton-and-time/gb-news.png",
    width: 200,
    height: 72,
  },
  {
    ...
    src: "/quote-logos/britton-and-time/money-marketing.png",
    width: 200,
    height: 72,
  },
  {
    id: "this-is-money",
    name: "This is Money",
    src: "/quote-logos/britton-and-time/this-is-money.png",
    width: 200,
    height: 72,
  },
];

/** Six logos — one row, same footprint as Canopy. */
export const FREEDOM_FEATURED_LOGOS: QuotePartnerLogo[] = [
  {
    id: "liver-uk",
    name: "Liver UK",
    src: "/quote-logos/freedom-insurance/liver-uk.png",
    width: 200,
    height: 72,
  },
  {
    id: "kids-cancer-charity",
    name: "Kids Cancer Charity",
    src: "/quote-logos/freedom-insurance/kids-cancer-charity.png",
    width: 200,
    height: 72,
  },
  {
    id: "lupus-uk",
    name: "LUPUS UK",
    src: "/quote-logos/freedom-insurance/lupus-uk.png",
    width: 200,
    height: 72,
  },
  {
    id: "anaphylaxis-uk",
    name: "Anaphylaxis UK",
    src: "/quote-logos/freedom-insurance/anaphylaxis-uk.png",
    width: 200,
    height: 72,
  },
  {
    id: "myeloma-uk",
    name: "Myeloma UK",
    src: "/quote-logos/freedom-insurance/myeloma-uk.png",
    width: 200,
    height: 72,
  },
  {
    id: "shine",
    name: "Shine",
    src: "/quote-logos/freedom-insurance/shine.png",
    width: 200,
    height: 72,
  },
];

/** Menzies Law rankings & press — one row under Menzies quote. */
export const MENZIES_FEATURED_LOGOS: QuotePartnerLogo[] = [
  {
    id: "legal-500",
    name: "Legal 500",
    src: "/quote-logos/menzies/legal-500.png",
    width: 200,
    height: 72,
  },
  {
    id: "chambers",
    name: "Chambers",
    src: "/quote-logos/menzies/chambers.png",
    width: 200,
    height: 72,
  },
  {
    id: "review-solicitors",
    name: "Review Solicitors",
    src: "/quote-logos/menzies/review-solicitors.png",
    width: 200,
    height: 72,
  },
  {
    id: "hr-news",
    name: "HR News",
    src: "/quote-logos/menzies/hr-news.png",
    width: 200,
    height: 72,
  },
  {
    id: "cipd",
    name: "CIPD",
    src: "/quote-logos/menzies/cipd.png",
    width: 200,
    height: 72,
  },
  {
    id: "google",
    name: "Google",
    src: "/quote-logos/menzies/google.png",
    width: 200,
    height: 72,
  },
];

/** Anywhere.com press — six logos, same footprint as Canopy. */
export const ANYWHERE_FEATURED_LOGOS: QuotePartnerLogo[] = [
  {
    id: "forbes",
    name: "Forbes",
    src: "/quote-logos/anywhere/forbes.png",
    width: 200,
    height: 72,
  },
  {
    id: "inc",
    name: "Inc.",
    src: "/quote-logos/anywhere/inc.png",
    width: 200,
    height: 72,
  },
  {
    id: "huffpost",
    name: "HuffPost",
    src: "/quote-logos/anywhere/huffpost.png",
    width: 200,
    height: 72,
  },
  {
    id: "millionaire-interviews",
    name: "Millionaire Interviews",
    src: "/quote-logos/anywhere/millionaire-interviews.png",
    width: 200,
    height: 72,
  },
  {
    id: "front",
    name: "Front",
    src: "/quote-logos/anywhere/front.png",
    width: 200,
    height: 72,
  },
  {
    id: "the-org",
    name: "The Org",
    src: "/quote-logos/anywhere/the-org.png",
    width: 200,
    height: 72,
  },
];

/** Heat from the Spire brands & press — one row under Heat quote. */
export const HEAT_FEATURED_LOGOS: QuotePartnerLogo[] = [
  {
    id: "salisbury-journal",
    name: "Salisbury Journal",
    src: "/quote-logos/heat-from-the-spire/salisbury-journal.png",
    width: 200,
    height: 72,
  },
  {
    id: "stone-island",
    name: "Stone Island",
    src: "/quote-logos/heat-from-the-spire/stone-island.png",
    width: 200,
    height: 72,
  },
  {
    id: "cp-company",
    name: "C.P. Company",
    src: "/quote-logos/heat-from-the-spire/cp-company.png",
    width: 200,
    height: 72,
  },
  {
    id: "trustpilot",
    name: "Trustpilot",
    src: "/quote-logos/heat-from-the-spire/trustpilot.png",
    width: 200,
    height: 72,
  },
  {
    id: "instagram",
    name: "Instagram",
    src: "/quote-logos/heat-from-the-spire/instagram-mark.png",
    width: 200,
    height: 72,
  },
  {
    id: "klarna",
    name: "Klarna",
    src: "/quote-logos/heat-from-the-spire/klarna.png",
    width: 200,
    height: 72,
  },
];

/** Shay Hasson previous ventures / FormX backers — one row under FormX quote. */
export const FORMX_FEATURED_LOGOS: QuotePartnerLogo[] = [
  {
    id: "sidekick",
    name: "SideKick",
    src: "/quote-logos/formx/sidekick.png",
    width: 200,
    height: 72,
  },
  {
    id: "wekix",
    name: "Wekix",
    src: "/quote-logos/formx/wekix.png",
    width: 200,
    height: 72,
  },
  {
    id: "wishi",
    name: "Wishi",
    src: "/quote-logos/formx/wishi.png",
    width: 200,
    height: 72,
  },
  {
    id: "optitex",
    name: "Optitex",
    src: "/quote-logos/formx/optitex.png",
    width: 200,
    height: 72,
  },
  {
    id: "designpax",
    name: "DesignPax",
    src: "/quote-logos/formx/designpax.png",
    width: 200,
    height: 72,
  },
  {
    id: "grove-ventures",
    name: "Grove Ventures",
    src: "/quote-logos/formx/grove-ventures.png",
    width: 200,
    height: 72,
  },
];
...
export const SERVICE_HIGHLIGHT_QUOTES: ServiceHighlightQuote[] = [
  ...
  },
  {
    ...
    partnerLogosLabel: "Featured in",
    partnerLogos: ANYWHERE_FEATURED_LOGOS,
  },
  {
    id: "formx",
    company: "FormX.com",
    location: "US",
    quote:
      "We've been with Bright Brand for a while now, and it still feels like they're in the business with us. They rebuilt the funnel, tightened the targeting, and cut our cost per booked sales meeting by 83%. Same budget, far more of the right conversations.",
    author: "Shay Hasson",
  ...
  },
  {
    ...
    location: "UK",
    quote:
      "Since the team started really getting hands-on with our account, we've seen a genuine shift. It's the difference between someone managing your account and someone actually caring about it - that closer attention has meant we're now seeing a solid return on our ad spend, something we hadn't consistently had before.",
    ...
    partnerLogosLabel: "Featured in",
    partnerLogos: FREEDOM_FEATURED_LOGOS,
  },
];

/**
 * Held back from the Services quote slider for now.
 * Move an entry back into SERVICE_HIGHLIGHT_QUOTES to show it again.
 */
export const SERVICE_HIGHLIGHT_QUOTES_HELD: ServiceHighlightQuote[] = [
  {
    ...
    partnerLogosLabel: "Recognised by",
    partnerLogos: MENZIES_FEATURED_LOGOS,
  },
  {
    ...
    location: "UK",
    quote:
      "The Bright Brand team scaled our Meta channel with real discipline and turned it into proper growth. They grew our revenue by 300% in a year, and it still feels like they are part of the business.",
    author: "Ben Herridge",
    role: "Managing Director & CEO",
    imageSrc: "/testimonials/ben-herridge.webp",
    imageAlt: "Ben Herridge",
    partnerLogosLabel: "Featured in",
    partnerLogos: HEAT_FEATURED_LOGOS,
  },
];
...
export const CLIENT_LOGOS = [
  ...
  { name: "Canopy", logo: "canopy.png", key: "canopy" },
  { name: "Direct2Compensation", logo: "direct2-compensation.png", key: "direct2", scale: 1.3 },
  { name: "Enexus", logo: "enexus.png", key: "enexus" },
  { name: "FormX", logo: "formx.png", key: "formx" },
  { name: "Rowe Co Solicitors", logo: "rowe-co-solicitors.png", key: "rowe-co", scale: 1.2 },
  { name: "Menzies Law", logo: "menzies-law.png", key: "menzies" },
  { name: "Freedom Travel Insurance", logo: "freedom-travel-insurance.png", key: "freedom" },
  { name: "Northwest Solicitors", logo: "northwest-solicitors.png", key: "northwest", scale: 1.2 },
];
...
export const PLATFORM_LOGOS = [
  { name: "Amazon Ads", key: "amazon" },
  { name: "ChatGPT Business", key: "chatgpt" },
  { name: "Meta Business", key: "facebook" },
  { name: "Google Partners", key: "google" },
  { name: "Gemini AI", key: "gemini" },
  { name: "Instagram Ads", key: "instagram" },
  { name: "Pinterest Business", key: "pinterest" },
  { name: "Reddit Ads", key: "reddit" },
...
export const HOMEPAGE_FEATURED_QUOTE = [
  ...SERVICE_HIGHLIGHT_QUOTES,
  ...SERVICE_HIGHLIGHT_QUOTES_HELD,
].find((quote) => quote.id === "britton-and-time")!;
...
export const ABOUT_HERO_HIGHLIGHTS: AboutHeroHighlight[] = [
  ...
  { value: "12+", label: "Industries we've grown brands across" },
  { value: "UK + US", label: "Markets we actively serve" },
];
...
export const TEAM: TeamMember[] = [
  {
    ...
    role: "Client Partner",
    seniority: "Partner",
    email: "lauren@thebrightbrand.com",
    startDate: "May 2017",
  ...
  },
  {
    ...
    email: "lynnette@thebrightbrand.com",
    startDate: "Jan 2019",
  ...
  },
  {
    ...
    seniority: "Director",
    email: "brandon@thebrightbrand.com",
    startDate: "Nov 2015",
