...
export const SERVICE_HIGHLIGHT_QUOTES: ServiceHighlightQuote[] = [
  ...
  },
  {
    ...
    location: "US",
    quote:
      "We've been with Bright Brand for a while now, and it still feels like they're in the business with us. They rebuilt the funnel, tightened the targeting, and cut our cost per booked sales meeting by 63%. Same budget, far more of the right conversations.",
    author: "Shay Hasson",
